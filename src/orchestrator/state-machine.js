...
const TRANSITIONS = {
  ...
  [STATES.RUN_AGENT]: [STATES.POST_PROCESS, STATES.FAILED, STATES.PAUSED],
  [STATES.POST_PROCESS]: [STATES.RUN_TESTS, STATES.FAILED],
  [STATES.RUN_TESTS]: [STATES.COMMIT_PUSH, STATES.RUN_AGENT, STATES.FAILED],
  ...
  [STATES.PAUSED]: [STATES.RUN_AGENT, STATES.FAILED],
  [STATES.COMPLETED]: [],
  [STATES.FAILED]: [],
};
